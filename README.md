...
## 功能
# 1. 主页
- 这是用户进入应用后的欢迎页面，简单介绍应用的核心功能，吸引用户登录或注册。点击之后回到 2（登录界面）。
...
- **注册页面**：新用户可以在这里创建账户，输入用户名、密码、电子邮件，或通过社交媒体注册。
...
- 用户可以浏览其他旅行者的帖子，分享自己的旅行经验。
  ...
  - 用户也可以点击按钮发布自己的旅行帖子，分享图片和文字内容。
    - 需要有发布界面，用户可以上传本地的图片和文字。
    - 需要打开别人的帖子，里面可以评论和点赞。

# 5. 旅行伴侣匹配页面
- 该页面显示潜在的旅行伴侣，提供用户的个人资料、距离和相似兴趣信息。
  - 用户可以点击查看详细资料，或点击“匹配”按钮与该伴侣建立联系。
  - **航班聊天室**：先建立一个筛选日期查找航班的功能，然后可以加入聊天室进行聊天。
...
# 8. 本地人最爱
- 显示本地人最近浏览的店，打开可以进行评论。
  - 这个我们做好了但是无法发布评论，最好再加一个导航的功能，需要用 Google 地图的 API。
