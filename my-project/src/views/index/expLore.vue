      ...
      <div class="right">
        ...
        <div class="post" style="margin-left: 60px;display: flex; align-items: center;align-content: center;">
          ...
          <div @click="toggleIcon"  style="padding-left: 20px">
            <svg v-if="isFirstIcon" t="1728712557733" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4247" width="30" height="30">
